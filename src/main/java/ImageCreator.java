...
//		
//		if(isColor){
//			degrade = new ColorImage(height, width, ImageFormat.BMP, ImageType.RGB);
//		} else{
//			degrade = new ColorImage(height, width, ImageFormat.BMP, ImageType.RGB);
//		}
//			
...
//	}
	...
	public static Image createBinaryImage(int height, int width) {
		Image binaryImage = new ColorImage(height, width, Image.ImageFormat.BMP, Image.ImageType.GRAYSCALE);
